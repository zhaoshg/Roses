...
public enum PriorityLevelEnum implements ReadableEnum<PriorityLevelEnum> {
    ...
    PriorityLevelEnum(String code, String message) {
        this.code = code;
    ...
    @Override
    public PriorityLevelEnum parseToEnum(String originValue) {
        if (ObjectUtil.isEmpty(originValue)) {
            return null;
        }
        for (PriorityLevelEnum value : PriorityLevelEnum.values()) {
