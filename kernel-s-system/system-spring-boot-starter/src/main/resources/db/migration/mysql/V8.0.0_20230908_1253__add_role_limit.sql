CREATE TABLE `sys_role_limit`  (
  `role_limit_id` bigint(0) NOT NULL COMMENT '主键',
  `role_id` bigint(0) NOT NULL COMMENT '角色id',
  `limit_type` tinyint(0) NOT NULL COMMENT '角色限制类型：1-角色可分配的菜单，2-角色可分配的功能',
  `business_id` bigint(0) NOT NULL COMMENT '业务id，为菜单id或菜单功能id',
